...
void main() {
    ...
    // gl_FragColor = vec4(vec3(normalize01(noise3.w)), 1.0);
    // gl_FragColor = vec4(vec3(normalize01(noise4.w)), 1.0);
    // gl_FragColor = vec4(vec3(normalize01(noise1.w + noise2.w)), 1.0);
    // gl_FragColor = vec4(vec3(normalize01(noise1.w + noise2.w + noise3.w)), 1.0);
